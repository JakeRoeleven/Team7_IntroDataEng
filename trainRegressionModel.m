...
% Auto-generated by MATLAB on 17-May-2022 13:01:19
...
predictorNames = {'ICSEA_value', 'Selective_school', 'School_gender', 'ASGS_remoteness', 'motor_vehicles_per_house', 'single_parent_families_pct', 'private_health_insurance_pct', 'retention_rate', 'crime_per_person', 'EducationScore', 'BEScore'};
...
concatenatedPredictorsAndResponse.attendance = response;
linearModel = fitlm(...
...
trainedModel.RequiredVariables = {'ASGS_remoteness', 'BEScore', 'EducationScore', 'ICSEA_value', 'School_gender', 'Selective_school', 'crime_per_person', 'motor_vehicles_per_house', 'private_health_insurance_pct', 'retention_rate', 'single_parent_families_pct'};
...
for fold = 1:KFolds
    ...
    concatenatedPredictorsAndResponse.attendance = trainingResponse;
    linearModel = fitlm(...
        concatenatedPredictorsAndResponse, ...
        'linear', ...
        'RobustOpts', 'off');
