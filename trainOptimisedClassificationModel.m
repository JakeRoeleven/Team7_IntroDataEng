...
trainedClassifier.RequiredVariables = {'ASGS_remoteness', 'BEScore', 'EducationScore', 'ICSEA_value', 'School_gender', 'Selective_school', 'crimes_per_person', 'motor_vehicles_per_house', 'private_health_insurance_pct', 'retention_rate', 'single_parent_families_pct'};
